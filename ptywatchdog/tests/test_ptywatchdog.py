...
class TestSubprocessObserver(unittest.TestCase):
    ...
    def test_start_once_detect(self):
        ...
        # setup the observer
        self.testobserver = PtyWatchdog()
        self.testobserver.expect('test_string', set_detected)
        ...
        self.testobserver.stop()
        self.testobserver.close()
    ...
    def test_start_once_crash(self):
        ...
        # setup the observer
        self.testobserver = PtyWatchdog(err_watchers={
        ...
        self.testobserver.attach(pid=self.testproc.pid)
